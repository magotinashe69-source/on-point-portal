...
import TeacherGamePlays from "@/pages/teacher/game-plays";
import QuestionBankPage from "@/pages/teacher/question-bank";
import ClassMasteryPage from "@/pages/teacher/class-mastery";
