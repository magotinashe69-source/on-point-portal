...
// Two features are not built yet, so they carry a "Coming soon" ribbon.
const FEATURES = [
  ...
  { title: "Fun Games", emoji: "🎮", bg: "#F3E8FF", desc: "Learn while you play — battles and more.", href: "/games", soon: true },
];
