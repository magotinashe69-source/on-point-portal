...
export const en = {
  ...
  register: {
    ...
    passwordResetNote: "Give the pupil the code shown. They sign in with it and choose a new password.",
    passwordNotReset: "Password not reset",
    firstLoginCodeTitle: "First sign-in codes",
    firstLoginCodesNote: "Give each pupil their own code. They sign in with their name and the code, then choose their own password. Codes are shown only now, and each works once.",
    firstLoginCodeDone: "I have written them down",
  ...
  login: {
    ...
    student: {
      ...
      firstTime: "First time logging in? Enter your name, and type the code your teacher gave you as your password. Then choose your own password.",
      passwordSet: "Your password is set. Use it next time you log in.",
      choosePasswordTitle: "Choose your password",
      choosePasswordNote: "Your code is right. Now choose the password you will use from now on.",
